...
//    var $ShoppingCartTotal = $("#CartTotal");  // The shopping cart total div 
    ...
    var PurchaseOrder = 0;   // will be generated by the database 
...
//        $ShoppingCartTotal.text(0.00);
    ...
    $("#order-submit").on("click", function() {  
        ...
        $("#customer-address1").text(Customer.addr1);
        $("#customer-address2").text(Customer.addr2);
        $("#customer-city").text(Customer.city);
        $("#customer-state").text(Customer.state);
        $("#customer-zip").text(Customer.zip);
        ...
        if (validateForm(Customer) == true) {
            ...
            DisplayOrderSummary(PurchaseOrder);
      ...
      function DisplayOrderSummary(Customer, PO) {

        // The customer data was populated on the summary page when it was submitted

        // Populate the Purchase Order number
